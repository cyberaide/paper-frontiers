...
As today's academic institutions provide machine learning and deep learning educational efforts, we attempt to identify if it is possible to leverage such activities to apply them as part of benchmarking machine learning efforts conducted by the community as part of MLCommons \cite{www-mlcommons,las-22-mlcommons-science}. 
