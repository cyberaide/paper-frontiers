...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.70\columnwidth]{images/Benchmark_comp_resource.png}
    \caption{Performance projection.}
    \label{fig:performance-projection-b}
\end{figure}

\begin{comment}
\begin{figure}[htb]    
    \centering
    \includegraphics[width=0.70\columnwidth]{images/Graphics_Cards_BestFit_bar.png}
    \caption{Performance projection.}
    \label{fig:performance-projection-c}
\end{figure}
\end{comment}
