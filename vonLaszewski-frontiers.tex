...
The MLCommons benchmarks also provide an ideal starting point for
...
\begin{itemize}
  ...
  \item {\bf Teamwork.} Students benefit from focusing on the
    success and collaboration of the entire team rather than mere
    ...
    fact that careful time planning in the team is needed to succeed.
