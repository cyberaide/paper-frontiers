...
\begin{figure}[p]
  ...
  \centering\includegraphics[width=0.75\columnwidth]{images/Graphics_Cards_BestFit_bar.png}

  {\bf (a)} Performance time measurements while using only 2 epochs on various systems with different GPUs.}

  \centering\includegraphics[width=0.75\columnwidth]{images/Benchmark_comp_resource.png}

  {\bf (a)} Performance time benchmark for various GPU cards on different systems and variation of epochs.}
