...
While initially observing the fast runtime of the RTX3090 on a custom
...
we developed and the event notifications we interwove throughout the
program provided evidence that we used the machine properly. The
energy traces are generated periodically every \TODO{how many seconds?}
seconds. The traces for 2, 30, and 70 epochs are depicted in Figure
...
\begin{figure}[p]
  ...
  \begin{center}
     \begin{minipage}[t]{0.65\textwidth}
        \includegraphics[width=1.0\linewidth]{images/A100-NNSE-all-epochs-training}
        {\bf (A)} NNSE over Prediction Parameters for training on A100.
     \end{minipage}
  \end{center}
  \ \
  \begin{center}
     \begin{minipage}[t]{0.65\textwidth}
        \includegraphics[width=1.0\linewidth]{images/A100-NNSE-all-epochs-validation}
        {\bf (B)} NNSE over Prediction Parameters for validation on A100.
     \end{minipage}
  \end{center}
