...
\tiny
\keyFont{ \section{Keywords:} deep learning, benchmarking, hyper parameter search, hybrid heterogeneous hyper parameter search, earthquake forecasting }
...
The MLCommons benchmarks provide an valuable starting point for
...
they become ideal targets for adaptation in AI classes that want to go
beyond typical starting applications such as MNIST.

We have gained practical experiences while adapting benchmarks from
the MLCommons Science Working group while collaborating with various
universities and student groups from University of Virginia, New York
University, and Indiana University. Furthermore, it was used in
...
\begin{itemize}
  ...
  \item {\bf Teamwork.} Students benefit from focusing on the success
    ...
    teams. This includes opportunity for pair programming, but also
  ...
  \item {\bf Interdiciplinary Research.} Many of the application in
    MLCommons are requiering interdiciplinary reaserch between domain
    scientists, ML experts, and IT engeneers. As part of the teamwork
  ...
  \item {\bf System Benchmarking vs. Science Benchmarking.} Students
    ...
    the system level benchmarking in which a system is compared based
    ...
    algorithm is compared between each other.
  ...
  \item {\bf Execution ecosystem.} While in-class problems typically
    ...
    remote system access, and a frugal planning of experiments through
    prediction of runtimes and planing of hyperparameter searches. This
  ...
  \item {\bf Professional and Academic Communication.} The results
    achived need to be communicated to a larger audience and the
    students have the ability to engage in report, paper, and
  ...
  \item {\bf Benefits to Society.} The MLCommons benchmarks are
    ...
    that can be applicabale to sociatal tasks. Obviously improving
    benchmarks such as earthquake forecasting is beneficitial to the
