...
to use the epoch values to be 2, 30, and 70. We took all results and sorted them for
training and validation separately by the accuracy values. This leads
to a ranking of the experiments by accuracy. In Table
\ref{tab:ranking-accuracy} we present the top 20 accuracy values, while
...
value it is also advantageous to analyze which parameter sets lead in
...
\begin{figure}[htb]
  ...
  \begin{center}
     ...
     \begin{minipage}[b]{0.40\textwidth}
       \includegraphics[width=1.0\linewidth]{images/energy_all_model_fit_kWh_per_epoch.pdf}
        {\bf (A)} A100 Energy trace for 2 epochs training and validation.
    \end{minipage}
     \ \
     \begin{minipage}[b]{0.40\textwidth}
     ...
     \begin{minipage}[b]{0.40\textwidth}
       \includegraphics[width=1.0\linewidth]{images/total_epoch_vs_watts.pdf}
        {\bf (E)} total epoch vs watts
     \end{minipage}
     \ \
     \begin{minipage}[b]{0.40\textwidth}
       \includegraphics[width=1.0\linewidth]{images/total_kWh_per_epoch.pdf}
        {\bf (F)}  total kWh per epoch
     \end{minipage}
\end{center}
