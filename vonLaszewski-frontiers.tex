...
was executed on Google Colab. In face the time on Google Colab,
although good for small epochs, quickly deteriorated with increasing
number of epochs due to the older GPUs available at that time on Google
Colab.
