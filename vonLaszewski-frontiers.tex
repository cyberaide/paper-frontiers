...
\TODO{PRELIMINARY. If contribution to paper is sufficient, they become
coauthors. THis has to be determined once we have paper in better shape.}
...
\item cloudmesh -- Cloudmesh is a large collection of repositories for
  ...
  resources. \url{\url{https://github.com/orgs/cloudmesh/repositories}
...
% \bibliography{vonLaszewski-references.bib}
