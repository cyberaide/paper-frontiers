...
\begin{figure}[p]
  ...
  \centering\includegraphics[width=0.45\columnwidth]{images/Graphics_Cards_BestFit_bar.pdf}

  {\bf (A)} Performance time measurements while using only 2 epochs on various systems with different GPUs.}

  \centering\includegraphics[width=0.45\columnwidth]{images/Benchmark_comp_resource.pdf}

  {\bf (B)} Performance time benchmark for various GPU cards on different systems and variation of epochs.}
