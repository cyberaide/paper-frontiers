...
\begin{figure}[htb]
  ...
  \begin{center}
     \begin{minipage}[b]{0.30\textwidth}
        ...
        {\bf (E.2)} Energy consumption for 2 epochs training and validation.\\
     \end{minipage}
     \ \
     \begin{minipage}[b]{0.30\textwidth}
        ...
        {\bf (E.30)} Energy consumption for 30 epochs training and validation.
     \end{minipage}
     \ \
     \begin{minipage}[b]{0.30\textwidth}
        ...
        {\bf (E.70)} Energy consumption for 70 epochs training and validation.
     \end{minipage}
  \end{center}

  \caption {Energy monitoring for 2, 30, and 70 Epochs}
  \label{fig:energy}
