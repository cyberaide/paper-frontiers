...
%%% There is no need for adding the file termination, as long as you
%%% indicate where the file is saved. In the examples below the files
%%% (logo1.eps and logos.eps) are in the Frontiers LaTeX folder
